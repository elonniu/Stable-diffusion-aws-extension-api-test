...
class TestSDXLE2E:
    ...
    def test_2_update_turbo_checkpoint(self):
        ...
        wget_file(
            ...
            'https://aws-gcr-solutions.s3.cn-north-1.amazonaws.com.cn/stable-diffusion-aws-extension-github-mainline/models/sd_xl_base_1.0.safetensors'
        )
        global signed_urls
    ...
    def test_4_turbo_txt2img_inference_job_create(self):
        ...
        upload_with_put(inference_data["api_params_s3_upload_url"], "./data/api_params/txt2img_sdxl_api_param.json")
